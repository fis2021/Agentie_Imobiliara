...
/*@BeforeEach
    ...
    rejectBooking(String Name, String hour,  String day,String month, String year, String Reason) throws IncorrectDateException, AgentDoesNotExistException, BookingNotFoundException
